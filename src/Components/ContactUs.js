  ...
  return (
    <div style={{
       ...
       <div className='pt-[66px] md:pt-[88px] pb-[66px] md:pb-0 px-[16px] md:px-0 '>
         ...
         <div>
          <input type='text' placeholder='Your Name' className='pl-[16px] md:pl-[24px] outline-none bg-blue-400  mx-auto py-[25px] md:py-[20px] w-[342px] md:w-[540px]  font-Poppins font-normal text-13 md:text-20 leading-[17px] md:leading-[26px] border border-grey-1500 rounded-lg text-white mt-[11px] md:mt-[30px] ml-0 md:ml-[72px]' />
          <input type='text' placeholder='yourmailaddressplease@mail.com' className='mt-[17px] md:mt-[56px] outline-none bg-blue-400    mx-auto pl-[11px] md:pl-[24px] py-[25px] md:py-[20px] w-[342px] md:w-[540px] font-Poppins font-light tet-13 md:text-20 leading-[13px] md:leading-[26px] border border-grey-1500 rounded-lg text-white ml-[7px] md:ml-[72px]' />
           ...
           <div > <img className='bg-cover w-full' src='/assets/images/blueArrow.png' alt=' ' /></div>
           </div>
          </div>
         </div>
        </div>
        <div className='w-[100%]' ><img   className='w-[100%] bg-cover ' src='/assets/images/Area.png' alt='' /></div>
       </div>
