...
function StorySection() {
  return (
    ...
    style={{
      ...
      <div className=''>
      <h2 className='text-white max-w-[384px] text-center md:text-start  mx-auto md:mx-0 font-Montserrat text-25 md:text-48   font-semibold leading-[31px] md:leading-[58px] pt-[50px] md:pt-[171px]'>OUR STORY WHO WE ARE</h2>
