  ...
  return (
    <div className='mt-[95px]  max-w-[1296px] mx-auto w-full'>
        ...
        <div className='w-[428px] mx-auto  flex gap-[9px] h-[76px] items-center rounded-full border border-grey-1300 '>
            <p className='w-[203px] px-[77px] py-[20px] text-center text-grey-1200  text-20 font-Montserrat font-semibold leading-[24px]'>Rent</p>
            <p className='w-[203px] px-[77px] py-[20px] text-center bg-blue-400 rounded-full text-20 font-Montserrat font-semibold leading-[24px] text-white'>Buy</p>
        </div >
        <div className='mt-[24px] p-[16px] bg-white shadow sdadow-md   rounded-[8px] border border-grey-1300 flex gap-[16px]'>
            ...
            <div className=' flex items-center gap-[10px] rounded-md border border-grey-1300  w-[180px]'>
            <p className='text-grey-300 font-Montserrat  font-normal text-16 leading-[19px] py-[15px] pl-[24px]'>Property Type</p>
            <select></select>
            </div>
